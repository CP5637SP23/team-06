<?php
/**
 * creativeminds Theme Customizer.
 *
 ...
 */
function creativeminds_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'theme_bg_color',
				array(
					'label'		=> __( 'Header and footer background color', 'creativeminds'),
					'section'	=> 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'interactive_color', array(
				'label'		=> __( 'Interactive color (links etc)', 'creativeminds' ),
				'section'	=> 'colors',
	...
	// Add a section to shift index content
	$wp_customize->add_section( 'theme_options',
		array(
			'title'			=> __( 'Theme Options', 'creativeminds' ),
			'priority'		=> 95,
			'capability'	=> 'edit_theme_options',
			'description'	=> __( 'choose how long of a post is showed on index and pages.', 'creativeminds' )
		)
	);

	// Create Extract or Full text settings
	$wp_customize->add_setting(	'length_setting',
		array(
			'default'			=> 'excerpt',
			'type'				=> 'theme_mod',
			'sanitize_callback' => 'creativeminds_sanitize_length', // Sanitization function appears further down
			'transport'			=> 'postMessage'
		)
	);

	// Add the controls
	$wp_customize->add_control(	'creativeminds_length_control',
		array(
			'type'		=> 'radio',
			'label'		=> __( 'Index/archive displays', 'creativeminds' ),
			'section'	=> 'theme_options',
			'choices'	=> array(
				'excerpt'		=> __( 'Extract (default)', 'creativeminds' ),
				'full-content'	=> __( 'Full text', 'creativeminds' )
			),
...
add_action( 'customize_register', 'creativeminds_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function creativeminds_customize_preview_js() {
	wp_enqueue_script( 'creativeminds_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'creativeminds_customize_preview_js' );
...
function creativeminds_sanitize_length( $value ) {
...
if ( ! function_exists( 'creativeminds_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see creativeminds_custom_header_setup().
 */
function creativeminds_header_style() {
