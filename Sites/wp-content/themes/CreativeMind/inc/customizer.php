...
function CreativeMinds_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'theme_options',
		array(
			...
			'description'	=> __( 'Change how much of a post is displayed on index and archive pages.', 'CreativeMinds' )
		)
	);
	...
	$wp_customize->add_control(	'CreativeMinds_length_control',
		array(
			...
			'choices'	=> array(
				'excerpt'		=> __( 'Excerpt (default)', 'CreativeMinds' ),
				'full-content'	=> __( 'Full content', 'CreativeMinds' )
			),
